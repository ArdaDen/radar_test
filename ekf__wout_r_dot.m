%% Extended Kalman Filter Without Radial Velocity
function [state_means,state_covs] = ekf__wout_r_dot(measurements,sensor_coor,Time,sampling_rate,state_mean_i, ...
...
for i = 1:length(t)
    ...
    [state_mean_i,state_cov_i] = measurement_update_wout_r_dot(state_mean_i_k,state_cov_i_k,measurements(:,i),measurement_noise_cov,sensor_coor,stick_length);
