...
function [state_means,state_covs] = iekf(measurements,sensor_coor,Time,sampling_rate,state_mean_i, ...
...
for i = 1:length(t)
    ...
    [state_mean_i_k,state_cov_i_k] = measurement_update(state_mean_i_k,state_cov_i_k,measurements(:,i),measurement_noise_cov,sensor_coor,stick_length);
    end
